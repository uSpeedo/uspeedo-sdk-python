...
from uspeedo.core.typesystem import schema
from uspeedo.core.typesystem import abstract
from uspeedo.core.exc import ValidationException
from uspeedo.core.utils.compat import str


class Dict(schema.Schema):
