...
from uspeedo.core.utils import compat


class USpeedoException(Exception):
    @property
    def retryable(self):
        return False
...
class TransportException(USpeedoException):
    pass
...
class RetCodeException(USpeedoException):
    def __init__(
...
class RetryTimeoutException(USpeedoException):
    pass


class ValidationException(USpeedoException):
