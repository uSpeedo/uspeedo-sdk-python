...
from uspeedo.services.asms.models.BatchWithFailure import BatchWithFailure
...
class SendBatchUSMSMessageResp(schema.ResponseSchema):
    ...
    fields = {
        "FailContent": fields.List(BatchWithFailure(), required=False, dump_to="FailContent", load_from="FailContent"),
