...
from uspeedo.services.email.models.Action__FailedTargetEmail import Action__FailedTargetEmail


class Action__SendEmailTemplateResponse(schema.ResponseSchema):

    """ Action__SendEmailTemplateResponse - 
    """

    fields = {
        "FailContent": fields.List(Action__FailedTargetEmail(), required=False, dump_to="FailContent", load_from="FailContent"),
