...
from uspeedo.services.email.models.FailedTargetEmail import FailedTargetEmail


class SendEmailTemplateRes(schema.ResponseSchema):
    ...
    fields = {
        ...
        "FailContent": fields.List(FailedTargetEmail(), required=False, dump_to="FailContent", load_from="FailContent"),
    }
