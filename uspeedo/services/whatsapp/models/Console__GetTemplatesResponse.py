...
class Console__GetTemplatesResponse(schema.Schema):
    ...
    fields = {
        "Paging":  Console__Paging(required=False, dump_to="Paging", load_from="Paging"),
        "Data": fields.List(Console__TemplateInfo(), required=False, dump_to="Data", load_from="Data"),
    }
